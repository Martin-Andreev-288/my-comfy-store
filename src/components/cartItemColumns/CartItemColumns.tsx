...
import { Mode } from "../selectProductAmount/SelectProductAmount";
...
// sm:ml-auto place the item in the right end! Otherwise it is right next
// to the amount/the setAmount selector and the remove button
